        ...
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content">
                ...
                <div>
                    ...
                    <Link to="/" className="link link-hover">My Bdjobs Panel</Link>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className=' columns-8  text-center' >
                    <p className=' '>Copyright @ 2023, All right reserved by Careers Banladesh Ltd</p>
                </div>

                <div className="md:place-self-center md:justify-self-end columns-3">
