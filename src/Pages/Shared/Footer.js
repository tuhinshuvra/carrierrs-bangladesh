        ...
        <footer>
            <div className="footer p-10 bg-base-200 text-base-content">
                <div className="items-center grid-flow-col">
                    ...
                    <p> <span className=' text-lg font-bold'>  Carriers Bangladesh. </span><br />Providing reliable job solution</p>
                </div>

                <div>
                    <span className="footer-title">Services</span>
                    <Link to="/" className="link link-hover">About careersbangldesh.com</Link>
                    <Link to="/" className="link link-hover">Accessibility Statement</Link>
                    <Link to="/" className="link link-hover">International Partners </Link>
                    <Link to="/" className="link link-hover">Other Partners </Link>
                ...
                <div>
                    <span className="footer-title">HOT LINK</span>
                    <Link to="/about" className="link link-hover">About us</Link>
                    <Link to="/contact" className="link link-hover">Contact</Link>
                    <Link to="/" className="link link-hover">Video Resume new</Link>
                    <Link to="/" className="link link-hover">My Jobs Panel</Link>
                    <Link to="/" className="link link-hover">List of Features</Link>
                    <Link to="/" className="link link-hover">Employability Test</Link>
                    <Link to="/" className="link link-hover">Career Counseling</Link>
                </div>
                ...
                <div>
                    ...
                    <Link to="/" className="link link-hover">Privacy policy</Link>
                    <Link to="/" className="link link-hover">Products/Service</Link>
                    <Link to="/" className="link link-hover">Disability Inclusion Practice</Link>
                    <Link to="/" className="link link-hover">Post a Job</Link>
                    <Link to="/" className="link link-hover">FAQ</Link>
                    <Link to="/" className="link link-hover">Cookie policy</Link>
                </div>
            </div>
            <div className="footer px-10 py-2 border-t bg-base-200 text-base-content border-base-300">
            ...
            <div className="footer px-10 py-2 border-t bg-base-200 text-base-content ">
                <div className="md:place-self-center md: justify-center">
                    <p className=' '>Copyright @ 2023, All right reserved by Careers Bangladesh Ltd</p>
                </div>
            </div>
        </footer>
    );
